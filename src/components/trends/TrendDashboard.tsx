                    ...
                    <div className="col-span-12 lg:col-span-6 min-w-0">
                        <section className="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-xl overflow-hidden min-h-[800px]">
                            ...
                            {/* <div className="p-10 prose dark:prose-invert prose-slate max-w-none 
                                ...
                                prose-th:bg-slate-50 dark:prose-th:bg-slate-800 prose-th:p-3
                            ...
                            <div className="p-10 prose dark:prose-invert prose-slate max-w-none">
                                <ReactMarkdown 
                                    ...
                                    components={{
                                        // Ép style cho H1
                                        h1: ({node, ...props}) => (
                                            <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white mb-8 border-b-2 border-blue-500 pb-4" {...props} />
                                        ),
                                        // Ép style cho H2 (Các tiêu đề chương của Agent)
                                        h2: ({node, ...props}) => (
                                            <h2 className="text-2xl font-black tracking-tight text-blue-600 dark:text-blue-400 mt-12 mb-6 flex items-center gap-3 before:content-[''] before:w-2 before:h-6 before:bg-blue-500 before:rounded-full" {...props} />
                                        ),
                                        // Ép style cho bảng để hiển thị kẻ ô
                                        table: ({node, ...props}) => (
